...
TEXTS = {
    "EN": {
        ...
        "tswrld_welcome": (
            "──────────────────────────────\n\n"
            "Welcome to TS World Collection\n\n"
            "──────────────────────────────\n\n"
    ...
    "AR": {
        "letmebot_welcome": (
            "👋 مرحباً بك في القناة الخاصة 👋\n\n"
            "نحن سعداء بانضمامك إلينا! 🎉\n\n"
            "احصل على محتوى حصري للبالغين، تحديثات يومية، ومميزات خاصة في قناتنا الخاصة على تليجرام.\n\n"
        ...
        "morevids_welcome": (
            "👋 مرحباً بك في القناة الخاصة 👋\n\n"
            "استمتع بالمحتوى الحصري، التحديثات، والمميزات في قناتنا الخاصة على تليجرام.\n\n"
    ...
    "ES": {
        "letmebot_welcome": (
            "👋 ¡Bienvenido al canal privado! 👋\n\n"
            "¡Estamos encantados de que te unas! 🎉\n\n"
        ...
        "tswrld_welcome": (
            "──────────────────────────────\n\n"
            "Bienvenido a TS World Collection\n\n"
            "──────────────────────────────\n\n"
...
def get_text(bot_name: str, lang="EN"):
    """
    bot_name: letmebot / onlytrns / tswrld / morevids
    lang: EN / AR / ES
    """
